...
exports.bookController = {
    getAllBooks: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const books = yield Book_1.default.find(searchBy ? { [searchBy]: searchValue } : {})
    ...
    getBook: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    createBook: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        if (!(0, BookValidator_1.validateBookCreated)(req.body)) {
            return res.status(400).json({
    ...
    updateBook: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        if (!(0, BookValidator_1.validateBookUpdated)(req.body)) {
            return res.status(400).json({
                code: CODE.INVALID_CREDENTIALS,
                data: 'Invalid data'
            });
        ...
        const bookId = req.params.bookId;
        try {
            const book = yield Book_1.default.findByIdAndUpdate(bookId, { $set: req.body }, { new: true });
            if (book) {
                return res.status(200).json({
                    code: CODE.SUCCESS,
                    data: book
